  ...
  <div class="row body">
    <form action="" method="POST">
      <ul> 
        ...
        <li>
          <p class="left">
            <label for="first_name">Media sponsor</label>
            <input type="text" name="media" placeholder="" />
          </p>
        </li> 
        <li>
          <p class="left">
            <label for="first_name">Shoe sponsor</label>
            <input type="text" name="shoe" placeholder="" />
          </p>
        </li> 
        <li>
          <p class="left">
            <label for="first_name">Jersey sponsor</label>
            <input type="text" name="jersey" placeholder="" />
          </p>
        </li> 
        <li>
          <p class="left">
            <label for="first_name">Equipment sponsor</label>
