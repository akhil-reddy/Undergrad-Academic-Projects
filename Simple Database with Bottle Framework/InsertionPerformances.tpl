  ...
  <div class="row body">
    <form action="" method="POST">
      <ul>
        ...
        <li>
          <p class="left">
            <label for="first_name">Player ID</label>
            <input type="text" name="pid" placeholder="" />
          </p>
          <p>
            <label for="first_name">Game ID</label>
            <input type="text" name="gid" placeholder="" />
          </p>
        </li>
        <li>
          <p>
            <label for="first_name">No. of twos</label>
            <input type="text" name="twos" placeholder="" />
          </p>
          <p>
            <label for="first_name">No. of threes</label>
            <input type="text" name="threes" placeholder="" />
          </p>
        </li>    
        <li>
          <p>
            <label for="first_name">Turnovers</label>
            <input type="text" name="turnovers" placeholder="" />
          </p>
        </li>  
        <li>
          <p>
            <label for="first_name">Field goal percentage</label>
            <input type="text" name="fgp" placeholder="" />
          </p>
        </li>   
        <li>
          <p class="left">
            <label for="first_name">Fouls</label>
            <input type="text" name="fouls" placeholder="" />
          </p>
        </li>    
        <li>
          <p class="left">
