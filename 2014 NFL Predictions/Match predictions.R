...
# Only picking players who have played in Week 17. If we don't do this, there will be bias from 
# players who have played only for half a season,etc.
...
# Finding the team rating by summing up player attributes columnwise.
# Also, distributing team ratings around the value 1000 to differentiate the ratings of different teams.
for(i in 1:32){
  for(j in 1:16){
...
predicted.rating=c()
# Making weighted predictions. Later weeks get precedenc eover earlier weeks.
for(i in 1:32){
...
# 3. Refining Model A with the help of model B
